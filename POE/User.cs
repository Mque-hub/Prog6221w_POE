...
namespace POE
{
    public  class User
    {
        public void UserInfo() 
        {
            ...
            Console.WriteLine("\n Hi There! Welcome to Mque Cybersecurity Bot! I will be assisting you today.");
            Console.WriteLine("\n What's your name? ");
            ...
            do
            {
                ...
                {
                    Console.WriteLine("What would you like to know about cybersecurity? What is cybersecurity? ");
                }
                ...
                {
                    Console.ForegroundColor = ConsoleColor.Green;
                    Console.WriteLine("We are currently in maintainance");
                }
                Console.WriteLine(" Anything else I can help with. (Y/N)");
                Console.ForegroundColor = ConsoleColor.Blue;
